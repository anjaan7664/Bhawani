<template>
  <div>
    ...
    <p>Welcome to Bhawani Industries!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Bhawani Industries's Website, located at bhawanindustries.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Bhawani Industries if you do not agree to take all
    ...
    <p>
      We employ the use of cookies. By accessing Bhawani Industries, you agreed
      to use cookies in agreement with the Bhawani Industries's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Bhawani Industries and/or its licensors own the
      intellectual property rights for all material on Bhawani Industries. All
      intellectual property rights are reserved. You may access this from
      Bhawani Industries for your own personal use subjected to restrictions set
      in these terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Bhawani Industries</li>
      <li>Sell, rent or sub-license material from Bhawani Industries</li>
      <li>Reproduce, duplicate or copy material from Bhawani Industries</li>
      <li>Redistribute content from Bhawani Industries</li>
    </ul>

    <p>
      Parts of this website offer an opportunity for users to post and exchange
      opinions and information in certain areas of the website. Bhawani
      Industries does not filter, edit, publish or review Comments prior to
      their presence on the website. Comments do not reflect the views and
      opinions of Bhawani Industries,its agents and/or affiliates. Comments
      reflect the views and opinions of the person who post their views and
      opinions. To the extent permitted by applicable laws, Bhawani Industries
    ...
    <p>
      Bhawani Industries reserves the right to monitor all Comments and to
    ...
    <p>
      You hereby grant Bhawani Industries a non-exclusive license to use,
    ...
    <p>
      ...
      hyperlink compensates the absence of Bhawani Industries; and (d) the link
    ...
    <p>
      ...
      e-mail to Bhawani Industries. Please include your name, your organization
    ...
    <p>
      No use of Bhawani Industries's logo or other artwork will be allowed for
...
export default {
  ...
  components: {},
  head: {
    title: "Terms And Conditions for our Company | Bhawani Industries Jodhpur",
