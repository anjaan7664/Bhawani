<template>
  <div>
    <h1 class="text-4xl strong">Privacy Policy for Bhawani Industries</h1>

    <p>
      At Bhawani Industries, accessible from bhawanindustries, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document
      contains types of information that is collected and recorded by Bhawani
      Industries and how we use it.
    </p>
    ...
    <p>
      ...
      <NuxtLink to="/Terms">Terms & Conditions Generator</NuxtLink>
    </p>
    ...
    <p>
      Bhawani Industries follows a standard procedure of using log files. These
    ...
    <p>
      Like any other website, Bhawani Industries uses 'cookies'. These cookies
    ...
    <P
      ...
      advertising partners of Bhawani Industries.</P
    >

    <p>
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on Bhawani Industries, which are sent
    ...
    <p>
      Note that Bhawani Industries has no access to or control over these
    ...
    <p>
      Bhawani Industries's Privacy Policy does not apply to other advertisers or
    ...
    <p>
      Bhawani Industries does not knowingly collect any Personal Identifiable
...
export default {
  ...
  components: {},
  head: {
    title: "Privacy Policy For Our Company | Bhawani Industries Jodhpur",
